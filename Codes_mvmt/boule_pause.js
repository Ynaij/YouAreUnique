var createScene = function () {
   ...
   // GUI
    ...
    box2.physicsImpostor = new BABYLON.PhysicsImpostor(box2,BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 5000000, restitution: 5 }, scene);
    box2.position.x=-30
    ...
    scene.registerBeforeRender(() => {
        ...
        if (sphere.intersectsMesh(box2,true)){
            ...
            //sphere.position = new BABYLON.Vector3(-20,20,10) //Modif position instant 
