var createScene = function () {
   ...
   // GUI
    ...
    var box3 = BABYLON.MeshBuilder.CreateBox("box", {height:10,width:1,depth:20}, scene);
    ...
    var box4 = BABYLON.MeshBuilder.CreateBox("box", {height:12,width:1,depth:21}, scene);
    ...
    var box5 = BABYLON.MeshBuilder.CreateBox("box", {height:10,width:1,depth:20}, scene);
    box5.physicsImpostor = new BABYLON.PhysicsImpostor(box5,BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0, restitution: 0 }, scene);
    box5.position.x=35;
    box5.position.y = 7;

    var box6 = BABYLON.MeshBuilder.CreateBox("box", {height:12,width:1,depth:21}, scene);
    box6.physicsImpostor = new BABYLON.PhysicsImpostor(box6,BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 10, restitution: 0 }, scene);
    box6.position.x=35;
    box6.position.y = 7;

    var box7 = BABYLON.MeshBuilder.CreateBox("box", {size:2.5}, scene);
    box7.physicsImpostor = new BABYLON.PhysicsImpostor(box6,BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 10, restitution: 0 }, scene);
    box7.position.x=20;
    ...
    scene.registerBeforeRender(() => {
        ...
        if (sphere.intersectsMesh(box3,true)){
            sphere.applyImpulse(new BABYLON.Vector3(0, 15, 0), sphere.position);
        }

        if (sphere.intersectsMesh(box5,true)){
            sphere.applyImpulse(new BABYLON.Vector3(0, 15, 0), sphere.position);
        }
        if (sphere.intersectsMesh(box7,true)){
            box7.dispose();
            dash = true;
        }
    });
